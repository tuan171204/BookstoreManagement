...
namespace BookstoreManagement.Controllers
{
    ...
    public class BookController : Controller
    {
        ...
        public async Task<IActionResult> Index(string searchString, int? authorId, int? publisherId, int? categoryId, string sortBy = "CreatedAt", string sortOrder = "desc", string statusFilter = "Active", int pageNumber = 1, int pageSize = 10)
        {
